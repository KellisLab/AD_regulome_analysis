...
prefstr = paste0(celltype,'.',path,".pctcut",pctcut,".nRUV",NRUV,".all")
# Directories:
...
pathdf$AD.path[pathdf$Pathology=="lateAD"] = 2

peak <- readRDS(paste0(celltype,".mtx.peak.rds"))
...
#    NRUV = 10
    ...
    if(0) {flist = c(flist, ' + TSSEnrichment')}  # don't use TSS
